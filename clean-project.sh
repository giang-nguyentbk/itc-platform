...
TO_BE_REMOVED_IN_ROOT_DIR=".libs .vscode autom4te.cache m4 aclocal.m4 ar-lib compile config.* configure configure~ depcomp install-sh libtool ltmain.sh Makefile Makefile.in missing"
